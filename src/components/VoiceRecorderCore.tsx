'use client'
/**
 * Example of VoiceRecorder using core modules
 * This demonstrates how to migrate existing components to use the new core system
 */

import { useRecorderAdapter } from '@/adapters/web/useRecorderAdapter'
...
export default function VoiceRecorderCore({
    ...
    const { recording, start, stop, error } = useRecorderAdapter();
